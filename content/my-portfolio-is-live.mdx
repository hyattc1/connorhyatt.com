...
First and foremost, a huge shoutout to **Ang Wei Feng** ([@tedawf](https://github.com/tedawf)) for creating the original portfolio template that inspired this site! His clean, minimal implementation provided the perfect foundation for my own version. You can check out his original repository at [github.com/tedawf/tedawf.com](https://github.com/tedawf/tedawf.com).

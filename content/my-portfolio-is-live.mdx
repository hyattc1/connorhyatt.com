...
summary: "My portfolio is live, but it’s more than just a website. Building it taught me valuable lessons about balancing design, tools, and  trial and error."
image: "/connorhyatt-com.png"
...
First and foremost, a huge shoutout to **Ang Wei Feng** ([@tedawf](https://github.com/tedawf)) for creating the original portfolio template that inspired this site! His clean, minimal implementation provided the perfect foundation for my own version. You can check out his original repository at [github.com/tedawf/tedawf.com](https://github.com/tedawf/tedawf.com){:target="_blank"}.
...
### 6. Connor Support: Your Interactive Guide
...
- **OpenAI API**: $10 to power the chatbot and generate embeddings.

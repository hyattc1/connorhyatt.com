---
title: "Rubik’s Cubes & LeetCode: An Unexpected Link"
summary: "Both cubing and programming train the brain in patterns, algorithms, and step by step problem solving."
image: "/cube.png"
  ...
  <tbody>
    ...
    <tr style={{ borderBottom: '2px solid #374151', height: '120px' }}>
      ...
      <td style={{ padding: '16px 16px 16px 32px', verticalAlign: 'middle' }}>
        ...
        <p className="text-sm text-gray-600 m-0">R U2 R2 U' R2 U' R2 U2 R</p>
      </td>
    </tr>
    <tr style={{ height: '120px' }}>
      ...
      <td style={{ padding: '16px 16px 16px 32px', verticalAlign: 'middle' }}>
        ...
        <p className="text-sm text-gray-600 m-0">R2 D R' U2 R D' R' U2 R'</p>
      </td>
    </tr>
  </tbody>
</table>
